...
#if defined(NDEBUG)
# error "ToHelpCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ToHelpCoin Signed Message:\n";
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfWork() && nHeight >= Params().LastPOWBlock() && nHeight <= Params().LastOnlyPoSPhase() || IsProofOfWork() && nHeight >= Params().NewLastPOWBlock())
...
{
    RenameThread("tohelpcoin-loadblk");
